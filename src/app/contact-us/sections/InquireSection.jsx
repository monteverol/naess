...
export default function InquireSection() {
  return (
    <section 
      className="md:px-20 lg:px-40 xl:px-60 lg:items-center p-8 w-full h-screen flex justify-center drop-shadow-[0_-4px_8px_rgba(0,0,0,0.25)] lg:drop-shadow-md bg-blue-100"
