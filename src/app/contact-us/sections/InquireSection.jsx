...
export default function InquireSection() {
  return (
    <section 
      className="lg:px-20 xl:px-40 lg:items-center p-8 w-full h-screen flex justify-center drop-shadow-[0_-4px_8px_rgba(0,0,0,0.25)] lg:drop-shadow-md bg-[#E9F2FC]"
