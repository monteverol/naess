import NewsArticle from "../../(pages)/news/components/ui/NewsArticle";
...
export default function NewsSection({ newsArticles }) {
  ...
  return(
    <section className="bg-white h-auto w-full p-8 md:px-20 lg:px-40 xl:px-60 flex gap-[40px] flex-col justify-center">
