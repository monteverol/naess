...
export default function CareerSection() {
  ...
  return(
    <div className="bg-[#F0F3F5] w-full h-auto py-8 flex items-center justify-center">
      <article className="w-[1120px] h-auto md:h-[260px] flex flex-col bg-[#FAFAFA] border-2 border-black drop-shadow-lg rounded-[8px] gap-[40px] p-8 transition-all duration-200 hover:drop-shadow-xl">
