...
export default function HighlightSection() {
  return(
    <div 
      className="h-auto section flex flex-col items-center justify-center"
      style={{
        backgroundImage: "linear-gradient(rgba(52, 110, 160, 0.9), rgba(52, 110, 160, 0.75)), url(/images/highlight-img.png)",
    ...
    >
      <article className="section-inner-width flex flex-col gap-[60px]">
