...
export default function ServicesSection() {
  ...
  return (
    <div className="section grid items-center justify-center bg-white h-auto border-[#346EA0] border-t-[20px]">
      <div className="bg-white flex flex-col gap-[40px] justify-center min-w-full max-w-full xl:w-7xl">
