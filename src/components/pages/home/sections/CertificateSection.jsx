export default function CertificateSection() {
  return(
    <div className="section bg-white h-auto grid items-center justify-center">
      <section className="section-inner-width flex flex-col justify-center gap-[54px]">
        <article className="flex flex-col gap-[60px]">
          ...
          <p className="text-[18px] w-full lg:w-[534px]">Recognized for excellence, certified for quality—our accreditations speak for our commitment to global standards.</p>
        </article>
