...
export default function CareerSection() {
  ...
  return(
    <div className="bg-[#F0F3F5] w-full h-auto section flex items-center justify-center">
      <article className="section-inner-width h-auto md:h-[260px] flex flex-col bg-[#FAFAFA] md:border-2 md:border-black drop-shadow-lg rounded-[8px] gap-[40px] p-8 transition-all duration-200 hover:drop-shadow-xl">
