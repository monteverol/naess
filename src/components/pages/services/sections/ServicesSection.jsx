const ServicesSection = ({ services, toggleService, activeService }) => {
  return(
    <div className="section bg-white grid items-center justify-center">
      <section id="services-section" className="section-inner-width">
        <h2 className="section-heading mb-16 text-gray-800">
